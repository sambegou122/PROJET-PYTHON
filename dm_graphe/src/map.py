...
def main():
    """
La fonction ouvre le fichier donné en argument, puis parcours chaque ligne du fichier, crée si un pays n'est pas dans le graphe (initialisé avant). Après ajoute les deux pays dans la ligne
